import { itemizedParams } from '../../../itemized-prompts.js';
...
async function updateTokenCount() {
    ...
    try {
        // Вызываем ту самую функцию из ядра SillyTavern
        ...
        if (params && params.totalTokensInPrompt) {
            ...
            // Если данных нет, значит промпт пустой
            tokenValueSpan.textContent = '0';
        }
    } catch (err) {
        console.warn('Token Tracker: ошибка при расчете itemizedParams', err);
    }
}
